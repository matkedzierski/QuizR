    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.DeleteAccountSuccess ? "Konto usunięte."
                : "";
        ...
        public async Task<ActionResult> DeleteAccount(DeleteAccountViewModel model)
        {
            ...
            ApplicationUser current = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            var result = await UserManager.DeleteAsync(current);
            if (result.Succeeded)
            {
                SignInManager.AuthenticationManager.SignOut();
                return RedirectToAction("Index", "Home", new { Message = ManageMessageId.DeleteAccountSuccess });
            }
            AddErrors(result);
            return View(model);
        }
